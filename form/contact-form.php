...
<div class="contact-page" id="contact">
    ...
    <div class="form-group-row">
        <div class="form-group">
            <label for="first-name">First Name <span style="color:#00c3ff">*</span></label>
            <input type="text" id="first-name" name="first_name" placeholder="First Name" required>
        </div>
        <div class="form-group">
            <label for="last-name">Last Name <!-- <span style="color:#00c3ff">*</span> --></label>
            <input type="text" id="last-name" name="last_name" placeholder="Last Name (Optional)">
        </div>
        </div>

        <div class="form-group-row">
            <div class="form-group">
                <label for="email">Business Email <span style="color:#00c3ff">*</span></label>
                <input type="email" id="email" name="email" placeholder="Business Email" required>
            </div>
            <div class="form-group">
                <label for="company">Company Name <!-- <span style="color:#00c3ff">*</span> --> </label>
        ...
        <div class="form-group-row">
            <div class="form-group">
                    <label for="reason">Country: <span style="color:#00c3ff">*</span></label>
                    <select name="country" id="reason" required>
            ...
            <div class="form-group">
            <label for="industry">Industry <span style="color:#00c3ff">*</span></label>
            <select id="industry" name="industry" class="form-control" required>
                ...
                <option value="Manufacturing - Consumer">Manufacturing - Consumer</option>
